...
export default async function AdminUsersPage() {
  ...
  const t = locale === "en"
    ? {
      ...
      demo: "Supabase admin mode is not configured, so live user management is unavailable.",
    }
    : {
      title: "用戶管理",
      ...
      demo: "未完成 Supabase admin 設定，暫時未能使用真實用戶管理。",
    };
  ...
  return (
    <section className="admin-mobile-ui section-shell py-10 sm:py-16">
      ...
      <div className="mt-10">
        ...
        {!usersData.authorized && usersData.mode === "live" ? (
