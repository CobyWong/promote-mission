...
export function MissionAcceptCard({ missionSlug, locale, minParticipants, currentParticipants, lifecyclePhase }: MissionAcceptCardProps) {
  ...
  const labels = locale === "en"
    ? {
      ...
      collaborator: "Add @missionone_hk as collaborator and include the mission hashtag in caption.",
      ...
      awaitingHint: "Mission accepted. Next step: publish Reel + add @missionone_hk collaborator. MissionOne will auto-sync from missionone_hk and classify your Reel by mission hashtag.",
    ...
    : {
      ...
      collaborator: "先將 @missionone_hk 設為協作者，並在 Caption 加上任務指定標籤。",
      accept: "接受任務",
      accepted: "已接受任務",
      restart: "重新接受任務",
      accepting: "接受中...",
      acceptedHint: "已成功申請。系統已根據同步的 Instagram Reels 自動建立任務提交。",
      awaitingHint: "已接受任務。下一步：發佈 Reels 並加入 @missionone_hk 協作者。系統會從 missionone_hk 自動同步，並按任務標籤分類你的 Reels。",
      lockedTitle: "等待人數開放",
