...
export function MissionAcceptCard({ missionSlug, locale, minParticipants, currentParticipants, lifecyclePhase }: MissionAcceptCardProps) {
  ...
  const labels = locale === "en"
    ? {
      ...
      collaborator: "Add @missionone_hk as collaborator, then sync Instagram or submit your Reel URL manually.",
      ...
      awaitingHint: "Mission accepted. Next step: publish Reel + add @missionone_hk collaborator. If Instagram is connected, sync can auto-complete; otherwise submit your Reel URL manually in the app.",
    ...
    : {
      ...
      collaborator: "先將 @missionone_hk 設為協作者，之後可同步 Instagram 或手動提交 Reel 連結。",
      accept: "接受任務",
      accepted: "已接受任務",
      restart: "重新接受任務",
      accepting: "接受中...",
      acceptedHint: "已成功申請。系統已根據同步的 Instagram Reels 自動建立任務提交。",
      awaitingHint: "已接受任務。下一步：發佈 Reels 並加入 @missionone_hk 協作者。若已連接 Instagram，可同步自動完成；否則請於 App 手動提交 Reel 連結。",
      lockedTitle: "等待人數開放",
